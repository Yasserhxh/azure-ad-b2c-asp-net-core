...
hbutton.onclick = function () {
    ...
    if (reftextval != lastgettstext) {
        ...
        var request = new XMLHttpRequest();
        request.open('POST', 'Home/GetTextToSpeech', true);
...
function getttsforword(word) {
    var request = new XMLHttpRequest();
    request.open('POST', 'Home/getttsforword', true);
    request.responseType = "blob";
...
ttbutton.onclick = function () {
    var request = new XMLHttpRequest();
    request.open('POST', 'Home/gettonguetwister', true);
...
function createDownloadLink(blob) {
    ...
    var request = new XMLHttpRequest();
    request.open('POST', 'Home/ackaud', true);
